...
#define _nstates2	3	/* checkState */
#define minseq2	25
#define maxseq2	26
#define _endstate2	2

#define _nstates1	14	/* thread2 */
#define minseq1	12
#define maxseq1	24
#define _endstate1	13

#define _nstates0	13	/* thread1 */
#define minseq0	0
#define maxseq0	11
...
#define PcheckState	((P2 *)_this)
typedef struct P2 { /* checkState */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#define Pthread2	((P1 *)_this)
typedef struct P1 { /* thread2 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#define Pthread1	((P0 *)_this)
typedef struct P0 { /* thread1 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
